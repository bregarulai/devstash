...
- `feature/` — Feature workflow lifecycle (load/start/review/test/explain/complete) — working file: `context/current-feature.md`
...
- `research/` — Run a research task to generate documentation
