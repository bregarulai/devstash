      ...
      <div className="max-w-6xl mx-auto px-5 pt-12 pb-7 grid gap-8 lg:grid-cols-[1.2fr_2.5fr]">
        ...
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-3">
          <div>
            ...
            <a href="#features" className="block text-muted-foreground text-sm py-1 hover:text-foreground transition-colors">
              Features
            </a>
            <a href="#ai" className="block text-muted-foreground text-sm py-1 hover:text-foreground transition-colors">
              AI
            </a>
            <a href="#pricing" className="block text-muted-foreground text-sm py-1 hover:text-foreground transition-colors">
              Pricing
            </a>
          </div>
          <div>
            <h4 className="text-[13px] font-bold mb-3">Account</h4>
            <Link href="/sign-in" className="block text-muted-foreground text-sm py-1 hover:text-foreground transition-colors">
              Sign In
            </Link>
            <Link href="/register" className="block text-muted-foreground text-sm py-1 hover:text-foreground transition-colors">
              Get Started
            </Link>
          </div>
          <div>
