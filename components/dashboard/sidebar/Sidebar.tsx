    ...
    <div className='relative flex h-screen flex-col bg-background'>
      ...
      <div className='flex-1 overflow-y-auto py-2 border-r border-border'>
        ...
        <div className='mb-4 mx-2'>
          {isExpanded && (
            <h3 className='mb-2 px-2 text-xs font-semibold tracking-wider text-muted-foreground'>
              Types
            </h3>
          )}
        ...
        {isExpanded && (
          <div className='mb-4 mx-2'>
            ...
            >
              <CollapsibleTrigger className='flex w-full items-center gap-1.5 cursor-pointer px-2 py-2 text-xs font-semibold tracking-wider text-muted-foreground transition-colors hover:text-foreground'>
                <ChevronDown
